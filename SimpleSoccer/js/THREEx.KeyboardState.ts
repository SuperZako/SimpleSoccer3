...
namespace THREEx {
    ...
    */
    export class KeyboardState {
        ...
        constructor(private domElement = document) {
        ...
        */
        ...
        static ALIAS: { [index: string]: number } = {
        ...
        */
        _onKeyChange = (event: KeyboardEvent) => {
            // log to debug
        ...
        */
         ...
         */
        eventMatches(event: KeyboardEvent, keyDesc: string) {
