...
namespace SimpleSoccer {
    ...
    export class SoccerTeam {
        ...
        public ReturnAllFieldPlayersToHome() {
            ...
            for (let it of this.m_Players) {
                ...
                if (it.Role() != player_role.goal_keeper) {
                    MessageDispatcher.Dispatcher.DispatchMsg(SEND_MSG_IMMEDIATELY, 1, it.ID(), MessageTypes.Msg_GoHome, null);
                }
            }
        }
         ...
         */
        GetBestPassToReceiver(passer: PlayerBase, receiver: PlayerBase, power: number) {
            //assert(PassTarget != null);
        ...
        public RequestPass(requester: FieldPlayer) {
            ...
            if (this.isPassSafeFromAllOpponents(this.ControllingPlayer().Pos(), requester.Pos(), requester, ParamLoader.MaxPassingForce)) {
                ...
                MessageDispatcher.Dispatcher.DispatchMsg(SEND_MSG_IMMEDIATELY, requester.ID(), this.ControllingPlayer().ID(), MessageTypes.Msg_PassToMe, requester);
